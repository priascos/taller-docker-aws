...
w2utils.event = {
    ...
    on: function (eventData, handler) {
        ...
        if (!eventData.type) { console.log('ERROR: You must specify event type when calling .bind() method of '+ this.name); return; }
        if (!handler) { console.log('ERROR: You must specify event handler function when calling .bind() method of '+ this.name); return; }
...
(function () {
        ...
        return $(this).each(function (index, el) {
            ...
            if (text === '' || text == null) {
                ...
                setTimeout(function () {
                    ...
                    .data('position', ($(el).offset().left + el.offsetWidth) + 'x' + $(el).offset().top)
                    .data('timer', timer);
                    $(el).off('keypress', tmp_hide).bind('keypress', tmp_hide).off('change', tmp_hide).bind('change', tmp_hide)
    ...
    $.fn.w2overlay = function (html, options) {
        ...
        div1.data('element', obj.length > 0 ? obj[0] : null)
            ...
            .fadeIn('fast').bind('mousedown', function (event) {
        ...
        setTimeout(function () {
            resize();
            $(document).off('click', hide).bind('click', hide);
            if (typeof options.onShow === 'function') options.onShow();
        }, 10);
...
(function () {
    ...
    w2grid.prototype = {
        ...
        refreshRanges: function () {
            ...
            // add resizer events
            $(this.box).find('#grid_'+ this.name +'_resizer').off('mousedown').bind('mousedown', mouseStart);
            //$(this.box).find('#grid_'+ this.name +'_resizer').off('selectstart').bind('selectstart', function () { return false; }); // fixes chrome cursror bug
            ...
            function mouseStart (event) {
                ...
                $(document).off('mousemove', mouseMove).bind('mousemove', mouseMove);
                $(document).off('mouseup', mouseStop).bind('mouseup', mouseStop);
            }
        ...
        keydown: function (event) {
            ...
            switch (key) {
                ...
                case 91: // cmd key
                    ...
                    $(document).bind('keyup', tmp_key_down);
        ...
        render: function (box) {
            ...
            $(this.box).bind('mousedown', mouseStart);
            $(this.box).bind('selectstart', function () { return false; }); // fixes chrome cursor bug
            ...
            if ($('.w2ui-layout').length == 0) { // if there is layout, it will send a resize event
                ...
                $(window).off('resize', this.tmp_resize).bind('resize', this.tmp_resize);
            }
            return (new Date()).getTime() - time;
            ...
            function mouseStart (event) {
                ...
                if (obj.last.userSelect == 'text') {
                    ...
                    $(this.box).bind('selectstart', function () { return false; });
                }
                ...
                $(document).bind('mouseup', mouseStop);
            }
        ...
        initColumnDrag: function ( box ) {
            ...
            $(obj.box).bind('mousedown', dragColStart);
            $(obj.box).bind('mouseup', catchMouseup);
            ...
            function dragColStart ( event ) {
                ...
                _dragData.timeout = setTimeout(function(){
                    ...
                    //add events
                    $( document ).bind( 'mouseup', dragColEnd );
                    $( document ).bind( 'mousemove', dragColOver );
        ...
        initToolbar: function () {
            ...
            if (typeof this.toolbar['render'] == 'undefined') {
                ...
                var obj = this;
                this.toolbar.bind('click', function (event) {
                    ...
                    switch (id) {
                        ...
                        case 'w2ui-search-advanced':
                            ...
                            if (it.checked) {
                                ...
                                $(document).bind('click', 'body', tmp_close);
                            }
                            break;
                        case 'w2ui-add':
                            // events
        ...
        initResize: function () {
            ...
            $(this.box).find('.w2ui-resizer')
                ...
                .bind('mousedown', function (event) {
                    ...
                    $(document).bind('mousemove', 'body', mouseMove);
                    $(document).bind('mouseup', 'body', mouseUp);
                })
        ...
        initSearches: function () {
            ...
            // add on change event
            $('#w2ui-overlay-searches-'+ this.name +' .w2ui-grid-searches *[rel=search]').bind('keypress', function (evnt) {
                if (evnt.keyCode == 13) {
                    obj.search();
                    $().w2overlay();
                }
    ...
    w2layout.prototype = {
        ...
        render: function (box) {
            ...
            function initEvents() {
                ...
                $(window).bind('resize', obj.tmp.events.resize);
            }
            ...
            function resizeStart(type, evnt) {
                ...
                if (!window.addEventListener) { window.document.attachEvent('onselectstart', function() { return false; } ); }
                $(document).off('mousemove', obj.tmp.events.mouseMove).bind('mousemove', obj.tmp.events.mouseMove);
                $(document).off('mouseup', obj.tmp.events.mouseUp).bind('mouseup', obj.tmp.events.mouseUp);
                obj.tmp.resize = {
                    type    : type,
                    x       : evnt.screenX,
                    y       : evnt.screenY,
            ...
            if (ptop !== null && ptop.hidden !== true) {
                ...
                if (ptop.resizable) {
                    ...
                    $('#layout_'+ this.name +'_resizer_top').show().css({
                        ...
                        'height': h + 'px',
                        'cursor': 'ns-resize'
                    }).off('mousedown').bind('mousedown', function (event) {
                        // event before
...
(function () {
    ...
    w2popup = {
        ...
        open: function (options) {
            ...
            // keyboard events
            if (options.keyboard) $(document).bind('keydown', this.keydown);
            ...
            $('#w2ui-popup .w2ui-msg-title').bind('mousedown', function (event) { mvStart(event); })
            ...
            function mvStart(evnt) {
                ...
                $(document).bind('mousemove', tmp.mvMove);
                $(document).bind('mouseup', tmp.mvStop);
        ...
        lockScreen: function (options) {
            ...
            if (options.modal == true) {
                $('#w2ui-lock').bind('mousedown', function () {
                    $('#w2ui-lock').css({
                ...
                $('#w2ui-lock').bind('mouseup', function () {
                    setTimeout(function () {
                        $('#w2ui-lock').css({
                            '-webkit-transition': '.1s',
                            '-moz-transition': '.1s',
                ...
                $('#w2ui-lock').bind('mouseup', function () { w2popup.close(); });
            }
            return true;
        },
        ...
        if (options.height > (w2popup.get().height - 50)) options.height = w2popup.get().height - 50;
          w2popup.message({
            ...
            html    : '<div style="position: absolute; top: 0px; left: 0px; right: 0px; bottom: 40px; overflow: auto">' +
                      ...
                      '</div>',
            onOpen: function () {
                $('#w2ui-popup .w2ui-popup-message .btn').bind('click', function (event) {
                    w2popup.message();
        ...
        w2popup.open({
            ...
            onOpen: function (event) {
                event.onComplete = function () {
                    $('#w2ui-popup .w2ui-popup-btn').bind('click', function (event) {
                        w2popup.close();
                        if (typeof options.callBack == 'function') options.callBack(event.target.id);
                        if (event.target.id == 'Yes' && typeof options.yes_callBack == 'function') options.yes_callBack();
                        if (event.target.id == 'No'  && typeof options.no_callBack == 'function') options.no_callBack();
...
(function ($) {
    ...
    /*     To add custom types
        $().w2field('addType', 'myType', function (options) {
            ...
            $(this.el).bind('blur', function (event)  { // keyCode & charCode differ in FireFox
                var ch = this.value;
                if (ch != 'a' && ch != 'b' && ch != 'c') {
    ...
    w2field.prototype = {
        ...
        init: function () {
            ...
            $(this.el)
                .addClass('w2field')
                .data('w2field', this)
                .bind('change',   this.tmp.onChange)
                .bind('click',    this.tmp.onClick)         // ignore click because it messes overlays
                .bind('focus',    this.tmp.onFocus)
                .bind('blur',     this.tmp.onBlur)
                .bind('keydown',  this.tmp.onKeydown)
                .bind('keyup',    this.tmp.onKeyup)
                .bind('keypress', this.tmp.onKeypress)
                .css({
        ...
        updateOverlay: function () {
            ...
            if (this.type == 'date') {
                ...
                (function refreshCalendar(month, year) {
                    ...
                    $('#w2ui-overlay .previous').bind('mousedown', function () {
                        var tmp = obj.options.current.split('/');
                        tmp[0]  = parseInt(tmp[0]) - 1;
                        refreshCalendar(tmp[0], tmp[1]);
                    });
                    $('#w2ui-overlay .next').bind('mousedown', function () {
                        var tmp = obj.options.current.split('/');
                        tmp[0]  = parseInt(tmp[0]) + 1;
                        refreshCalendar(tmp[0], tmp[1]);
                    });
        ...
        */
        ...
        addFocus: function () {
            ...
            helper.find('input')
                ...
                .bind('keyup',    function (event) { obj.keyUp(event) })
                .bind('keydown',  function (event) { obj.keyDown(event) })
                .bind('keypress', function (event) { obj.keyPress(event); });
            // MAIN div
            helper.bind('click', function (event) { $(this).find('input').focus(); });
            obj.refresh();
        },    
        ...
        addMulti: function () {
            ...
            if (obj.type == 'enum') {
                ...
                div.find('input')
                    ...
                    .bind('keyup',    function (event) { obj.keyUp(event) })
                    .bind('keydown',  function (event) { obj.keyDown(event) })
                    .bind('keypress', function (event) { div.find('.w2ui-enum-placeholder').remove(); obj.keyPress(event); });
                // MAIN div
                div.bind('click', function (event) { $(this).find('input').focus(); });
            }
            if (obj.type == 'file') {
                $(obj.el).css('outline', 'none');
    ...
    w2form.prototype = {
        ...
        refresh: function () {
            ...
            for (var f in this.fields) {
                ...
                if (tmp) tmp.clear();
                $(field.$el).off('change').bind('change', function () {
            ...
            $(this.box).find('button, input[type=button]').each(function (index, el) {
                $(el).off('click').bind('click', function (event) {
        ...
        render: function (box) {
            ...
            if (typeof this.tabs.render !== 'function') {
                ...
                this.tabs.bind('click', function (event) {
            ...
            if ($('.w2ui-layout').length == 0) { // if there is layout, it will send a resize event
                this.tmp_resize = function (event) { w2ui[obj.name].resize(); }
                $(window).off('resize', 'body').bind('resize', 'body', this.tmp_resize);
            }
